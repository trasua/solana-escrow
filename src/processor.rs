...
impl Processor {
    ...
    fn process_init_escrow(
        ...
        let owner_change_instruction = spl_token::instruction::set_authority(
            ...
            /*account_to_change_authority=*/temp_token_account.key,
            /*new_account_owner=*/Some(&pda),
            /*type_of_authority=*/spl_token::instruction::AuthorityType::AccountOwner,
            /*current_account_owner=*/initializer.key,
            /*public_key_signing_the_cross_program_invoke=*/&[&initializer.key],
        )?;
